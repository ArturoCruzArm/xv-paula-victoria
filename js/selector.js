...
const STORAGE_KEY = 'paulavictoria_selecciones';
const KEY_FILTER  = 'paulavictoria_filtro';
const KEY_SCROLL  = 'paulavictoria_scroll';
const KEY_LAST    = 'paulavictoria_ultima_foto';
